	...
	{	
		...
		foreach(new i: PVehicles)
		{
			if(x == pvData[i][cVeh])
			{
				...
				ShowPlayerDialog(playerid, DIALOG_MODTBUY, DIALOG_STYLE_LIST, "Kota Greenwich - Vehicle Toys", string, "Pilih", "Batal");
			}
		}
	}
...
CMD:vtoys(playerid)
{
	...
	{	
		...
		if(x == pvData[i][cVeh])
		{
			...
			ShowPlayerDialog(playerid, DIALOG_MODTOY, DIALOG_STYLE_LIST, "Kota Greenwich - Vehicle Toys", string, "Pilih", "Batal");
		}
	}
