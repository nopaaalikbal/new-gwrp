...
stock ShowContacts(playerid)
{
	...
	ShowPlayerDialog(playerid, DIALOG_PHONE_CONTACT, DIALOG_STYLE_LIST, "{ffffff}Greenwich Roleplay - Daftar Kontak", string, "Pilih", "Kembali");
	return 1;
}
...
stock ShowContacts(playerid)
{
	...
	ShowPlayerDialog(playerid, DIALOG_PHONE_CONTACT, DIALOG_STYLE_LIST, "Greenwich - Contact List", string, "Pilih", "Kembali");
	return 1;
}
forward OnContactAdd(playerid, id);
public OnContactAdd(playerid, id)
