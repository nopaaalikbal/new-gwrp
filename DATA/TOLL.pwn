...
// 	format(strings, sizeof(strings), "[TOLL]\n{FFFFFF}Press H atau /opengate");
// 	CreateDynamic3DTextLabel(strings, COLOR_YELLOW, 1804.82, 811.42, 10.91, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); 

// 	format(strings, sizeof(strings), "[TOLL]\n{FFFFFF}Press H atau /opengate");
// 	CreateDynamic3DTextLabel(strings, COLOR_YELLOW, 1788.63, 811.42, 10.91, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); 

// 	format(strings, sizeof(strings), "[TOLL]\n{FFFFFF}Press H atau /opengate");
// 	CreateDynamic3DTextLabel(strings, COLOR_YELLOW, 59.65, -1524.74, 4.95, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); 
	
// 	format(strings, sizeof(strings), "[TOLL]\n{FFFFFF}Press H atau /opengate");
// 	CreateDynamic3DTextLabel(strings, COLOR_YELLOW, 59.23, -1539.90, 5.10, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); 
// }
					...
					if(BarrierInfo[i][brOrg] == TEAM_NONE)
					{
						if(!BarrierInfo[i][brOpen])
						{
							...
							else
							{
								...
								SetTimerEx("BarrierClose",8000,0,"i",i);
								BarrierInfo[i][brOpen] = true;
								Toll(playerid, "Cepat!!! Toll akan menutup Kembali setelah 8 detik");
