...
new PlayerText:INVINFO[MAX_PLAYERS][16];
...
function OnPlayerGiveInvItem(playerid, userid, itemid, name[], value)
{
	...
	if(!strcmp(name, "Uang", true))
	{
		...
		SendStaffMessage(COLOR_YELLOW, ""YELLOW_E"{7fffd4}[PAYLOGS] [%s] telah memberikan uang kepada [%s] sejumlah [%s]", GetRPName(playerid), GetRPName(userid), FormatMoney(value));
	...
	else if(!strcmp(name, "Chiken", true))
	{
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(userid, "chiken", str, 19847, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(userid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pChiken] -= value;
		pData[userid][pChiken] += value;
	}
	else if(!strcmp(name, "Ktp", true))
	{
		...
		PlayerTextDrawSetString(userid, ktpwarga[playerid][12], strings);
		// Set birtdate
		// format(strings, sizeof(strings), "%s", pData[playerid][pTinggi]);
		// PlayerTextDrawSetString(userid, ktpwarga[playerid][18], strings);

		format(strings, sizeof(strings), "%s", pData[playerid][pAge]);
		PlayerTextDrawSetString(userid, ktpwarga[playerid][16], strings);

		format(strings, sizeof(strings), "%s", pData[playerid][pGender]);
		PlayerTextDrawSetString(userid, ktpwarga[playerid][17], strings);

		for(new txd; txd < 24; txd++)
		{
			PlayerTextDrawShow(userid, ktpwarga[playerid][txd]);
		}
...
public OnPlayerUseItem(playerid, itemid, name[])
{
	...
	else if(!strcmp(name, "BackPack"))
	{
		...
		SuccesMsg(playerid, "Anda Diberi Kompensasi 10 Snack, 10 Water, $1000");
...
public OnPlayerDropItem(playerid, itemid, name[])
{
	...
	else if(!strcmp(name, "Jerigen"))
	{
		...
		ShowProgressbar(playerid, "Membuang jerigen..", 3);
		ApplyAnimation(playerid, "BOMBER", "BOM_Plant", 4.1, 0, 0, 0, 0, 0, 1);
		new string[128];
		format(string, sizeof(string), "> %s Telah membuang jerigen.", GetRPName(playerid));
		SetPlayerChatBubble(playerid, string, COLOR_PURPLE, 30.0, 10000);
 		ShowItemBox(playerid, "Jerigen", "Removed_1x", InventoryData[playerid][itemid][invModel], 2);
		Inventory_Close(playerid);
	}
	else if(!strcmp(name, "Cabai"))
	{
	...
	{
		pData[playerid][pPerban] -= 1;
		ShowProgressbar(playerid, "Membuang perban..", 3);
		ApplyAnimation(playerid, "BOMBER", "BOM_Plant", 4.1, 0, 0, 0, 0, 0, 1);
		new string[128];
		format(string, sizeof(string), "> %s Telah membuang perban.", GetRPName(playerid));
		SetPlayerChatBubble(playerid, string, COLOR_PURPLE, 30.0, 10000);
 		ShowItemBox(playerid, "Perban", "Removed_1x", InventoryData[playerid][itemid][invModel], 2);
		Inventory_Close(playerid);
	}
	else if(!strcmp(name, "Obat_Stress"))
	{
...
stock CreatePlayerInv(playerid)
{
	...
	INVINFO[playerid][1] = CreatePlayerTextDraw(playerid, 352.000, 200.000, "LD_SPAC:white");
	...
	INVINFO[playerid][2] = CreatePlayerTextDraw(playerid, 352.000, 221.000, "LD_SPAC:white");
	PlayerTextDrawTextSize(playerid, INVINFO[playerid][2], 60.000, 19.000);
	...
	INVINFO[playerid][3] = CreatePlayerTextDraw(playerid, 352.000, 242.000, "LD_SPAC:white");
	PlayerTextDrawTextSize(playerid, INVINFO[playerid][3], 60.000, 19.000);
	...
	INVINFO[playerid][4] = CreatePlayerTextDraw(playerid, 352.000, 263.000, "LD_SPAC:white");
	PlayerTextDrawTextSize(playerid, INVINFO[playerid][4], 60.000, 18.000);
	...
	INVINFO[playerid][5] = CreatePlayerTextDraw(playerid, 352.000, 284.000, "LD_SPAC:white");
	PlayerTextDrawTextSize(playerid, INVINFO[playerid][5], 60.000, 18.000);
	...
	INVINFO[playerid][6] = CreatePlayerTextDraw(playerid, 382.000, 204.000, "Jumlah");
	...
	INVINFO[playerid][7] = CreatePlayerTextDraw(playerid, 382.000, 225.000, "Gunakan");
	...
	INVINFO[playerid][8] = CreatePlayerTextDraw(playerid, 382.000, 246.000, "Berikan");
	...
	INVINFO[playerid][9] = CreatePlayerTextDraw(playerid, 382.000, 267.000, "Buang");
	PlayerTextDrawLetterSize(playerid, INVINFO[playerid][9], 0.189, 1.098);
	...
	INVINFO[playerid][10] = CreatePlayerTextDraw(playerid, 382.000, 288.000, "Tutup");
	PlayerTextDrawLetterSize(playerid, INVINFO[playerid][10], 0.189, 1.098);
	...
	INVINFO[playerid][11] = CreatePlayerTextDraw(playerid, 359.000, 173.000, "");
	PlayerTextDrawLetterSize(playerid, INVINFO[playerid][11], 0.300, 1.898);
	PlayerTextDrawAlignment(playerid, INVINFO[playerid][11], 2);
	PlayerTextDrawColor(playerid, INVINFO[playerid][11], -1523963137);
	...
	INVINFO[playerid][12] = CreatePlayerTextDraw(playerid, 362.000, 175.000, "");
	PlayerTextDrawLetterSize(playerid, INVINFO[playerid][12], 0.300, 1.898);
	...
	INVINFO[playerid][13] = CreatePlayerTextDraw(playerid, 384.000, 177.000, "Greenwich");
	PlayerTextDrawLetterSize(playerid, INVINFO[playerid][13], 0.180, 0.898);
	PlayerTextDrawAlignment(playerid, INVINFO[playerid][13], 2);
	PlayerTextDrawColor(playerid, INVINFO[playerid][13], -1);
	PlayerTextDrawSetShadow(playerid, INVINFO[playerid][13], 0);
	PlayerTextDrawSetOutline(playerid, INVINFO[playerid][13], 0);
	PlayerTextDrawBackgroundColor(playerid, INVINFO[playerid][13], 150);
	PlayerTextDrawFont(playerid, INVINFO[playerid][13], 1);
	PlayerTextDrawSetProportional(playerid, INVINFO[playerid][13], 1);

	INVINFO[playerid][14] = CreatePlayerTextDraw(playerid, 384.000, 185.000, "Roleplay");
	PlayerTextDrawLetterSize(playerid, INVINFO[playerid][14], 0.180, 0.898);
	PlayerTextDrawAlignment(playerid, INVINFO[playerid][14], 2);
	PlayerTextDrawColor(playerid, INVINFO[playerid][14], -1);
	PlayerTextDrawSetShadow(playerid, INVINFO[playerid][14], 0);
	PlayerTextDrawSetOutline(playerid, INVINFO[playerid][14], 0);
	PlayerTextDrawBackgroundColor(playerid, INVINFO[playerid][14], 150);
	PlayerTextDrawFont(playerid, INVINFO[playerid][14], 1);
	PlayerTextDrawSetProportional(playerid, INVINFO[playerid][14], 1);

	INVINFO[playerid][15] = CreatePlayerTextDraw(playerid, 347.000, 166.000, "LD_SPAC:white");
	PlayerTextDrawTextSize(playerid, INVINFO[playerid][15], 70.000, 2.000);
	PlayerTextDrawAlignment(playerid, INVINFO[playerid][15], 1);
	PlayerTextDrawColor(playerid, INVINFO[playerid][15], 16423679);
...
stock BarangMasuk(playerid)
{
		...
		Inventory_Set(playerid, "BackPack", 2919, pData[playerid][pStarterpack], 2);
		Inventory_Set(playerid, "Batu", 905, pData[playerid][pBatu], pData[playerid][pBatu]);
		Inventory_Set(playerid, "linggis", 333, pData[playerid][pLinggis], pData[playerid][pLinggis]);
		Inventory_Set(playerid, "Component", 3096, pData[playerid][pComponent], pData[playerid][pComponent]);
		Inventory_Set(playerid, "Batu_Cucian", 2936, pData[playerid][pBatuCucian], pData[playerid][pBatuCucian]);
		Inventory_Set(playerid, "Material", 11708, pData[playerid][pMaterial], pData[playerid][pMaterial]);
		...
		//Inventory_Set(playerid, "Skck", 1581, pData[playerid][pSkck], pData[playerid][pSkck]);
