...
CMD:elist(playerid, params[])
{
	...
	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, "Anim List", string, "Close","");
    return 1;
}
...
{
	new name[20];
	if(sscanf(params, "s[20]S()[128]", name))
		return InfoMsg(playerid, "/e [Nama animasi]");

	if(!strcmp(name, "duduk", true))
	{
        ApplyAnimation(playerid,"Attractors","Stepsit_in",4.1, 0, 1, 1, 1, 1, 1);
	}
	else if (!strcmp(name, "x", true))
	{
    ...
    else if(!strcmp(name, "relax", true))
	{
       ApplyAnimation(playerid, "CRACK", "crckidle1",4.0, 1, 0, 0, 0, 0, 1);
	}
	else if(!strcmp(name, "mengecek", true))
	{
...
CMD:animlist(playerid, params[])// 24/02/2014
{
    ...
    strcat(str, ""LG_E"/lifejump - /exhaust - /leftslap - /carlock - /hoodfrisked - /lightcig - /tapcig - /boxer - /lay2 - /chant - /finger\n");
...
/*CMD:sleep(playerid,params[])
{
	...
	switch(anim){
		case 1: ApplyAnimation(playerid,"CRACK","crckdeth4",4.0, 1, 0, 0, 0, 0, 1);
		case 2: ApplyAnimation(playerid,"CRACK","crckidle2",4.0, 1, 0, 0, 0, 0, 1);
	}
	return 1;
}*/
...
CMD:breathless(playerid,params[])
{
	...
	switch(anim){
		case 1: ApplyAnimation(playerid,"PED","IDLE_tired",4.0, 1, 0, 0, 0, 0, 1);
		case 2: ApplyAnimation(playerid,"FAT","IDLE_tired",4.0, 1, 0, 0, 0, 0, 1);
...
CMD:poli(playerid,params[])
{
	...
	switch(anim){
		case 1:ApplyAnimation(playerid,"POLICE","CopTraf_Come",4.0, 1, 0, 0, 0, 0, 1);
		case 2:ApplyAnimation(playerid,"POLICE","CopTraf_Stop",4.0, 1, 0, 0, 0, 0, 1);
...
CMD:cross(playerid,params[])
{
	...
	switch(anim){
		case 1: ApplyAnimation(playerid, "COP_AMBIENT", "Coplook_loop", 4.0, 1, 0, 0, 0, 0, 1);
		case 2: ApplyAnimation(playerid, "DEALER", "DEALER_IDLE", 4.0, 1, 0, 0, 0, 0, 1);
		case 3: ApplyAnimation(playerid, "DEALER", "DEALER_IDLE_01", 4.0, 1, 0, 0, 0, 0, 1);
		case 4: ApplyAnimation(playerid,"GRAVEYARD","mrnM_loop",4.0, 1, 0, 0, 0, 0, 1);
		case 5: ApplyAnimation(playerid,"GRAVEYARD","prst_loopa",4.0, 1, 0, 0, 0, 0, 1);
...
CMD:jiggy(playerid,params[])
{
	...
	switch(anim){
		case 1: ApplyAnimation(playerid,"DANCING","DAN_Down_A",4.0, 1, 0, 0, 0, 0, 1);
		case 2: ApplyAnimation(playerid,"DANCING","DAN_Left_A",4.0, 1, 0, 0, 0, 0, 1);
		case 3: ApplyAnimation(playerid,"DANCING","DAN_Loop_A",4.0, 1, 0, 0, 0, 0, 1);
		case 4: ApplyAnimation(playerid,"DANCING","DAN_Right_A",4.0, 1, 0, 0, 0, 0, 1);
		case 5: ApplyAnimation(playerid,"DANCING","DAN_Up_A",4.0, 1, 0, 0, 0, 0, 1);
		case 6: ApplyAnimation(playerid,"DANCING","dnce_M_a",4.0, 1, 0, 0, 0, 0, 1);
		case 7: ApplyAnimation(playerid,"DANCING","dnce_M_b",4.0, 1, 0, 0, 0, 0, 1);
		case 8: ApplyAnimation(playerid,"DANCING","dnce_M_c",4.0, 1, 0, 0, 0, 0, 1);
		case 9: ApplyAnimation(playerid,"DANCING","dnce_M_c",4.0, 1, 0, 0, 0, 0, 1);
		case 10: ApplyAnimation(playerid,"DANCING","dnce_M_d",4.0, 1, 0, 0, 0, 0, 1);
...
CMD:ped(playerid,params[])
{
	...
	switch(anim){
		case 1: ApplyAnimation(playerid,"PED","JOG_femaleA",4.0, 1, 1, 1, 1, 1, 1);
		case 2: ApplyAnimation(playerid,"PED","JOG_maleA",4.0, 1, 1, 1, 1, 1, 1);
		case 3: ApplyAnimation(playerid,"PED","WOMAN_walkfatold",4.0, 1, 1, 1, 1, 1, 1);
		case 4: ApplyAnimation(playerid,"PED","run_fat",4.0, 1, 1, 1, 1, 1, 1);
		case 5: ApplyAnimation(playerid,"PED","run_fatold",4.0, 1, 1, 1, 1, 1, 1);
		case 6: ApplyAnimation(playerid,"PED","run_old",4.0, 1, 1, 1, 1, 1, 1);
		case 7: ApplyAnimation(playerid,"PED","Run_Wuzi",4.0, 1, 1, 1, 1, 1, 1);
		case 8: ApplyAnimation(playerid,"PED","swat_run",4.0, 1, 1, 1, 1, 1, 1);
		case 9: ApplyAnimation(playerid,"PED","WALK_fat",4.0, 1, 1, 1, 1, 1, 1);
		case 10: ApplyAnimation(playerid,"PED","WALK_fatold",4.0, 1, 1, 1, 1, 1, 1);
		case 11: ApplyAnimation(playerid,"PED","WALK_gang1",4.0, 1, 1, 1, 1, 1, 1);
		case 12: ApplyAnimation(playerid,"PED","WALK_gang2",4.0, 1, 1, 1, 1, 1, 1);
		case 13: ApplyAnimation(playerid,"PED","WALK_old",4.0, 1, 1, 1, 1, 1, 1);
		case 14: ApplyAnimation(playerid,"PED","WALK_shuffle",4.0, 1, 1, 1, 1, 1, 1);
		case 15: ApplyAnimation(playerid,"PED","woman_run",4.0, 1, 1, 1, 1, 1, 1);
		case 16: ApplyAnimation(playerid,"PED","WOMAN_runbusy",4.0, 1, 1, 1, 1, 1, 1);
		case 17: ApplyAnimation(playerid,"PED","WOMAN_runfatold",4.0, 1, 1, 1, 1, 1, 1);
		case 18: ApplyAnimation(playerid,"PED","woman_runpanic",4.0, 1, 1, 1, 1, 1, 1);
		case 19: ApplyAnimation(playerid,"PED","WOMAN_runsexy",4.0, 1, 1, 1, 1, 1, 1);
		case 20: ApplyAnimation(playerid,"PED","WOMAN_walkbusy",4.0, 1, 1, 1, 1, 1, 1);
		case 21: ApplyAnimation(playerid,"PED","WOMAN_walkfatold",4.0, 1, 1, 1, 1, 1, 1);
		case 22: ApplyAnimation(playerid,"PED","WOMAN_walknorm",4.0, 1, 1, 1, 1, 1, 1);
		case 23: ApplyAnimation(playerid,"PED","WOMAN_walkold",4.0, 1, 1, 1, 1, 1, 1);
		case 24: ApplyAnimation(playerid,"PED","WOMAN_walkpro",4.0, 1, 1, 1, 1, 1, 1);
		case 25: ApplyAnimation(playerid,"PED","WOMAN_walksexy",4.0, 1, 1, 1, 1, 1, 1);
		case 26: ApplyAnimation(playerid,"PED","WOMAN_walkshop",4.0, 1, 1, 1, 1, 1, 1);
...
CMD:rap(playerid,params[])
{
	...
	switch(rapstyle){
		...
		case 2: ApplyAnimation(playerid,"RAPPING","RAP_B_Loop",4.0, 1, 0, 0, 0, 0, 1);
		case 3: ApplyAnimation(playerid,"RAPPING","RAP_C_Loop",4.0, 1, 0, 0, 0, 0, 1);
...
CMD:gesture(playerid,params[])
{
	...
	switch(gesture){
		case 1: ApplyAnimation(playerid,"GHANDS","gsign1",4.0, 1, 0, 0, 0, 0, 1);
		case 2: ApplyAnimation(playerid,"GHANDS","gsign1LH",4.0, 1, 0, 0, 0, 0, 1);
		case 3: ApplyAnimation(playerid,"GHANDS","gsign2",4.0, 1, 0, 0, 0, 0, 1);
		case 4: ApplyAnimation(playerid,"GHANDS","gsign2LH",4.0, 1, 0, 0, 0, 0, 1);
		case 5: ApplyAnimation(playerid,"GHANDS","gsign3",4.0, 1, 0, 0, 0, 0, 1);
		case 6: ApplyAnimation(playerid,"GHANDS","gsign3LH",4.0, 1, 0, 0, 0, 0, 1);
		case 7: ApplyAnimation(playerid,"GHANDS","gsign4",4.0, 1, 0, 0, 0, 0, 1);
		case 8: ApplyAnimation(playerid,"GHANDS","gsign4LH",4.0, 1, 0, 0, 0, 0, 1);
		case 9: ApplyAnimation(playerid,"GHANDS","gsign5",4.0, 1, 0, 0, 0, 0, 1);
		case 10: ApplyAnimation(playerid,"GHANDS","gsign5",4.0, 1, 0, 0, 0, 0, 1);
		case 11: ApplyAnimation(playerid,"GHANDS","gsign5LH",4.0, 1, 0, 0, 0, 0, 1);
		case 12: ApplyAnimation(playerid,"GANGS","Invite_No",4.0, 1, 0, 0, 0, 0, 1);
		case 13: ApplyAnimation(playerid,"GANGS","Invite_Yes",4.0, 1, 0, 0, 0, 0, 1);
		case 14: ApplyAnimation(playerid,"GANGS","prtial_gngtlkD",4.0, 1, 0, 0, 0, 0, 1);
		case 15: ApplyAnimation(playerid,"GANGS","smkcig_prtl",4.0, 1, 0, 0, 0, 0, 1);
...
CMD:smoke(playerid,params[])
{
	...
	switch(gesture){
		case 1: ApplyAnimation(playerid,"SMOKING","M_smk_in",4.0, 1, 0, 0, 0, 0, 1);
		case 2: ApplyAnimation(playerid,"SMOKING","M_smklean_loop",4.0, 1, 0, 0, 0, 0, 1);
...
CMD:chora(playerid,params[]) { ApplyAnimation(playerid, "COP_AMBIENT", "Coplook_watch",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:relax(playerid,params[]) { ApplyAnimation(playerid, "CRACK", "crckidle1",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:crabs(playerid,params[]) { ApplyAnimation(playerid,"MISC","Scratchballs_01",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:greeting(playerid,params[]) { ApplyAnimation(playerid,"ON_LOOKERS","Pointup_loop",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:stop(playerid,params[]) { ApplyAnimation(playerid,"PED","endchat_01",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:wash(playerid,params[]) { ApplyAnimation(playerid,"BD_FIRE","wash_up",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:mourn(playerid,params[]) { ApplyAnimation(playerid,"GRAVEYARD","mrnF_loop",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:followme(playerid,params[]) { ApplyAnimation(playerid,"WUZI","Wuzi_follow",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:still(playerid,params[]) { ApplyAnimation(playerid,"WUZI","Wuzi_stand_loop", 4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:hitch(playerid,params[]) { ApplyAnimation(playerid,"MISC","Hiker_Pose", 4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:palmbitch(playerid,params[]) { ApplyAnimation(playerid,"MISC","bitchslap",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:cpranim(playerid,params[]) { ApplyAnimation(playerid,"MEDIC","CPR",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:giftgiving(playerid,params[]) { ApplyAnimation(playerid,"KISSING","gift_give",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:slap2(playerid,params[]) { ApplyAnimation(playerid,"SWEET","sweet_ass_slap",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:pump(playerid,params[]) { ApplyAnimation(playerid, "BOMBER", "BOM_Plant", 4.0, 1, 0, 0, 0, 0, 1); return 1; }
...
CMD:crack(playerid,params[]) { ApplyAnimation(playerid, "CRACK", "crckdeth2", 4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:fuck(playerid,params[]) { ApplyAnimation(playerid,"PED","fucku",4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:taichi(playerid,params[]) { ApplyAnimation(playerid,"PARK","Tai_Chi_Loop", 4.0, 1, 0, 0, 0, 0, 1); return 1; }
CMD:entrenar(playerid,params[]) { ApplyAnimation(playerid,"PARK","Tai_Chi_Loop", 4.0, 1, 0, 0, 0, 0, 1); return 1; } // amin para magos
CMD:kiss(playerid,params[]) { ApplyAnimation(playerid,"KISSING","Playa_Kiss_01",4.0, 1, 0, 0, 0, 0, 1); return 1; }
...
CMD:robman(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_RED, "USAGE: "WHITE_E" /robman [1-4]");
	}
	return 1;
}
CMD:carjacked2(playerid, params[])//18, 12:59pm, 4/27/2012
{
	 ApplyAnimation(playerid,"PED","CAR_jackedRHS",4.0, 1, 0, 0, 0, 0, 1);
     return 1;
}
/*CMD:handsup(playerid, params[])//19 1:00 pm , 4/27/2012
{
	SetPlayerSpecialAction(playerid,SPECIAL_ACTION_HANDSUP);
	//ApplyAnimation(playerid, "ROB_BANK","SHP_HandsUp_Scr",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}*/
...
{
	ApplyAnimation(playerid,"ped", "ARRESTgun", 4.0, 1, 0, 0, 0, 0, 1); // Gun Arrest
	return 1;
}
CMD:crossarms(playerid, params[])//28
{
	ApplyAnimation(playerid, "COP_AMBIENT", "Coplook_loop", 4.0, 1, 0, 0, 0, 0, 1); // Arms crossed
	return 1;
}
...
{
	ApplyAnimation(playerid, "FOOD", "EAT_Burger", 4.0, 1, 0, 0, 0, 0, 1); // Eat Burger
	return 1;
}
...
{
	ApplyAnimation(playerid, "SWEET", "sweet_ass_slap", 4.0, 1, 0, 0, 0, 0, 1); // Ass Slapping
 	return 1;
}

CMD:dealer(playerid, params[])//35
{
	ApplyAnimation(playerid, "DEALER", "DEALER_DEAL", 4.0, 1, 0, 0, 0, 0, 1); // Deal Drugs
	return 1;
}
...
CMD:chat(playerid, params[])//39
{
	...
	if(num == 1) { ApplyAnimation(playerid,"PED","IDLE_CHAT",4.0, 1, 0, 0, 0, 0, 1); }
	if(num == 2) { ApplyAnimation(playerid,"MISC","Idle_Chat_02",4.0, 1, 0, 0, 0, 0, 1); }
    return 1;
}

CMD:fucku(playerid, params[])//40
{
	ApplyAnimation(playerid,"PED","fucku",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}
...
{
	ApplyAnimation(playerid,"PED","KO_skid_front",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}
...
CMD:sup(playerid, params[])//47
{
	...
	if(number == 1) { ApplyAnimation(playerid,"GANGS","hndshkba",4.0, 1, 0, 0, 0, 0, 1); }
	if(number == 2) { ApplyAnimation(playerid,"GANGS","hndshkda",4.0, 1, 0, 0, 0, 0, 1); }
    if(number == 3) { ApplyAnimation(playerid,"GANGS","hndshkfa_swt",4.0, 1, 0, 0, 0, 0, 1); }
   	return 1;
}
...
{
	ApplyAnimation(playerid,"WAYFARER","WF_Fwd",4.0, 1, 0, 0, 0, 0, 1);
	return 1;
}
...
{
	ApplyAnimation(playerid,"PED","KO_shot_face",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}
...
{
	ApplyAnimation(playerid,"PED","EV_dive",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}
...
{
	ApplyAnimation(playerid,"PED","BIKE_elbowL",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:rollfall(playerid, params[])//60
{
	ApplyAnimation(playerid,"PED","BIKE_fallR",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:carlock(playerid, params[])//61
{
	ApplyAnimation(playerid,"PED","CAR_doorlocked_LHS",4.0, 1, 0, 0, 0, 0, 1);
	return 1;
}

CMD:rcarjack1(playerid, params[])//62
{
	ApplyAnimation(playerid,"PED","CAR_pulloutL_LHS",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:lcarjack1(playerid, params[])//63
{
	ApplyAnimation(playerid,"PED","CAR_pulloutL_RHS",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}
CMD:rcarjack2(playerid, params[])//64
{
	ApplyAnimation(playerid,"PED","CAR_pullout_LHS",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:lcarjack2(playerid, params[])//65
{
	ApplyAnimation(playerid,"PED","CAR_pullout_RHS",4.0, 1, 0, 0, 0, 0, 1);
	return 1;
}

CMD:hoodfrisked(playerid, params[])//66
{
	ApplyAnimation(playerid,"POLICE","crm_drgbst_01",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}
...
{
	ApplyAnimation(playerid,"SMOKING","M_smk_tap",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:bat(playerid, params[])//69
{
	ApplyAnimation(playerid,"BASEBALL","Bat_IDLE",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:boxer(playerid, params[])//70
{
	ApplyAnimation(playerid,"GYMNASIUM","GYMshadowbox",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:lay2(playerid, params[])//71
{
	ApplyAnimation(playerid,"SUNBATHE","Lay_Bac_in",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}
...
{
	ApplyAnimation(playerid,"RIOT","RIOT_FUKU",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}
...
{
	ApplyAnimation(playerid,"SWORD","sword_block",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:elbow(playerid, params[])//76
{
	ApplyAnimation(playerid,"FIGHT_D","FightD_3",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:kneekick(playerid, params[])//77
{
	ApplyAnimation(playerid,"FIGHT_D","FightD_2",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:fstance(playerid, params[])//78
{
	ApplyAnimation(playerid,"FIGHT_D","FightD_IDLE",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:gpunch(playerid, params[])//79
{
	ApplyAnimation(playerid,"FIGHT_B","FightB_G",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:airkick(playerid, params[])//80
{
	ApplyAnimation(playerid,"FIGHT_C","FightC_M",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}

CMD:gkick(playerid, params[])//81
{
	ApplyAnimation(playerid,"FIGHT_D","FightD_G",4.0, 1, 0, 0, 0, 0, 1);
    return 1;
}
...
CMD:knife(playerid, params[])//86
{
	...
	switch(nbr)
	{
		case 1: { ApplyAnimation(playerid,"KNIFE","KILL_Knife_Ped_Damage",4.0, 1, 0, 0, 0, 0, 1); }
		case 2: { ApplyAnimation(playerid,"KNIFE","KILL_Knife_Ped_Die",4.0, 1, 0, 0, 0, 0, 1); }
		case 3: { ApplyAnimation(playerid,"KNIFE","KILL_Knife_Player",4.0, 1, 0, 0, 0, 0, 1); }
		case 4: { ApplyAnimation(playerid,"KNIFE","KILL_Partial",4.0, 1, 0, 0, 0, 0, 1); }
	}
	return 1;
}
...
CMD:basket(playerid, params[])//87
{
    ...
    switch(ddr)
	{
		...
		case 2: { ApplyAnimation(playerid,"BSKTBALL","BBALL_Jump_Shot",4.0, 1, 0, 0, 0, 0, 1); }
		case 3: { ApplyAnimation(playerid,"BSKTBALL","BBALL_pickup",4.0, 1, 0, 0, 0, 0, 1); }
		case 4: { ApplyAnimation(playerid,"BSKTBALL","BBALL_run",4.0, 1, 0, 0, 0, 0, 1); }
...
CMD:reload(playerid, params[])//88
{
    ...
    {
		ApplyAnimation(playerid,"UZI","UZI_reload",4.0, 1, 0, 0, 0, 0, 1);
    }
...
CMD:gwalk(playerid, params[])//89
{
	...
	if (ssr == 1) { ApplyAnimation(playerid,"PED","WALK_gang1",4.0, 1, 0, 0, 0, 0, 1); }
 	if (ssr == 2) { ApplyAnimation(playerid,"PED","WALK_gang2",4.0, 1, 0, 0, 0, 0, 1); }
   	return 1;
}
...
CMD:aim(playerid, params[])//90
{
	...
	if(lmb == 1) { ApplyAnimation(playerid,"PED","gang_gunstand",4.0, 1, 0, 0, 0, 0, 1); }
    if(lmb == 2) { ApplyAnimation(playerid,"PED","Driveby_L",4.0, 1, 0, 0, 0, 0, 1); }
    if(lmb == 3) { ApplyAnimation(playerid,"PED","Driveby_R",4.0, 1, 0, 0, 0, 0, 1); }
...
CMD:lean(playerid, params[])//91
{
    ...
    if(mj == 1) { ApplyAnimation(playerid,"GANGS","leanIDLE",4.0, 1, 0, 0, 0, 0, 1); }
	if(mj == 2) { ApplyAnimation(playerid,"MISC","Plyrlean_loop",4.0, 1, 0, 0, 0, 0, 1); }
   	return 1;
}
...
CMD:strip(playerid, params[])//93
{
	...
	if(kj == 1) { ApplyAnimation(playerid,"STRIP", "strip_A", 4.0, 1, 0, 0, 0, 0, 1 ); }
	if(kj == 2) { ApplyAnimation(playerid,"STRIP", "strip_B", 4.0, 1, 0, 0, 0, 0, 1 ); }
    if(kj == 3) { ApplyAnimation(playerid,"STRIP", "strip_C", 4.0, 1, 0, 0, 0, 0, 1 ); }
    if(kj == 4) { ApplyAnimation(playerid,"STRIP", "strip_D", 4.0, 1, 0, 0, 0, 0, 1 ); }
    if(kj == 5) { ApplyAnimation(playerid,"STRIP", "strip_E", 4.0, 1, 0, 0, 0, 0, 1 ); }
    if(kj == 6) { ApplyAnimation(playerid,"STRIP", "strip_F", 4.0, 1, 0, 0, 0, 0, 1 ); }
    if(kj == 7) { ApplyAnimation(playerid,"STRIP", "strip_G", 4.0, 1, 0, 0, 0, 0, 1 ); }
 	return 1;
}
...
CMD:wank(playerid, params[])
{
	...
	{
		ApplyAnimation(playerid,"PAULNMAC","wank_in",4.0, 1, 0, 0, 0, 0, 1);
	...
	if(strcmp(choice, "2", true) == 0)
	{
		ApplyAnimation(playerid, "PAULNMAC", "wank_out", 4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	return 1;
}
CMD:sexy(playerid, params[])
{
	...
	if(strcmp(choice, "1", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKING_IDLEW",4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "2", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKING_IDLEP",4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "3", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKINGW",4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "4", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKINGP",4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "5", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKEDW",4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "6", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKEDP",4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "7", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKING_ENDW",4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "8", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKING_ENDP",4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	return 1;
}
...
{
	ApplyAnimation(playerid,"WUZI","Wuzi_stand_loop", 4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
	return 1;
}
...
{
	ApplyAnimation(playerid,"WUZI","Wuzi_follow",4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
    return 1;
}
...
{
	ApplyAnimation(playerid,"PED","getup",4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
	return 1;
}
CMD:slapped(playerid, params[])
{
	ApplyAnimation(playerid,"SWEET","ho_ass_slapped",4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
    return 1;
}
...
CMD:win(playerid, params[])
{
	...
	if(strcmp(choice, "1", true) == 0)
	{
		ApplyAnimation(playerid,"CASINO","cards_win", 4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "2", true) == 0)
	{
		ApplyAnimation(playerid,"CASINO","Roulette_win", 4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	return 1;
}
...
CMD:celebrate(playerid, params[])
{
	...
	if(strcmp(choice, "2", true) == 0)
	{
		ApplyAnimation(playerid,"GYMNASIUM","gym_tread_celebrate", 4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	return 1;
}
...
CMD:deal(playerid, params[])
{
	...
	if(strcmp(choice, "2", true) == 0)
	{
		ApplyAnimation(playerid,"DEALER","DRUGS_BUY", 4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	return 1;
}
...
{
	ApplyAnimation(playerid,"FOOD","SHP_Thank", 4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
	return 1;
}
...
CMD:invite1(playerid, params[])
{
	...
	if(strcmp(choice, "1", true) == 0)
	{
		ApplyAnimation(playerid,"GANGS","Invite_Yes",4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "2", true) == 0)
	{
		ApplyAnimation(playerid,"GANGS","Invite_No",4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	return 1;
}
...
{
	ApplyAnimation(playerid, "GRAFFITI", "graffiti_Chkout", 4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
	return 1;
}
CMD:nod(playerid, params[])
{
	ApplyAnimation(playerid,"COP_AMBIENT","Coplook_nod",4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
	return 1;
}
...
{
	ApplyAnimation(playerid,"RIOT","RIOT_ANGRY",4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
	return 1;
}
CMD:benddown(playerid, params[])
{
	ApplyAnimation(playerid, "BAR", "Barserve_bottle", 4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
	return 1;
}
CMD:shakehead(playerid, params[])
{
	ApplyAnimation(playerid, "MISC", "plyr_shkhead", 4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
	return 1;
}
CMD:cockgun(playerid, params[])
{
	ApplyAnimation(playerid, "SILENCED", "Silence_reload", 4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
	return 1;
}
CMD:bar(playerid, params[])
{
	...
	if(strcmp(choice, "1", true) == 0)
	{
		ApplyAnimation(playerid, "BAR", "Barcustom_get", 4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "2", true) == 0)
	{
		ApplyAnimation(playerid,"GHANDS","gsign2LH",4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "2", true) == 0)
	{
		ApplyAnimation(playerid, "BAR", "Barcustom_order", 4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "3", true) == 0)
	{
		ApplyAnimation(playerid, "BAR", "Barserve_give", 4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "4", true) == 0)
	{
		ApplyAnimation(playerid, "BAR", "Barserve_glass", 4.0, 1, 0, 0, 0, 0, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	return 1;
}
...
{
	ApplyAnimation(playerid, "CARRY", "liftup", 4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
	return 1;
}
...
{
	ApplyAnimation(playerid, "CARRY", "putdwn", 4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
	return 1;
}
...
{
	ApplyAnimation(playerid,"GANGS","smkcig_prtl",4.0, 1, 0, 0, 0, 0, 1);
	SetPVarInt(playerid, "UsingAnim", 1);
	return 1;
}
