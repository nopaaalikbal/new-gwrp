...
public ShowHouse(playerid)
{
	...
	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, "House Info", line9, "{e31d1d}Close","");
...
public ShowBis(playerid)
{
	...
	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, "Bisnis Info", line9, "{e31d1d}Close","");
	return 1;
}
