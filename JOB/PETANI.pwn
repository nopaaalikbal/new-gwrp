...
CMD:belibibitdentot(playerid, params[])
{
    if(pData[playerid][pJob] == 7)
	{
...
CMD:plantdentot(playerid, params[])
{
    if(pData[playerid][pJob] == 7)
	{
		if(pData[playerid][pProgress] == 1) return ErrorMsg(playerid, "Anda masih memiliki activity progress!");
...
CMD:prosesdentot(playerid, params[])
{
    if(pData[playerid][pJob] == 7)
	{
		if(pData[playerid][pProgress] == 1) return ErrorMsg(playerid, "Anda masih memiliki activity progress!");
...
CMD:jualberasdentot(playerid, params[])
{
	if(pData[playerid][pVip] > 0)
	{
	    if(pData[playerid][pProgress] == 1) return ErrorMsg(playerid, "Anda masih memiliki activity progress!");
	    if(pData[playerid][pBeras] < 50) return ErrorMsg(playerid, "Anda Tidak Memiliki 1 Paket Beras");
	    ShowProgressbar(playerid, "Menjual Beras..", 10);
		ApplyAnimation(playerid,"INT_HOUSE","wash_up",4.0, 1, 0, 0, 0, 0,1);
		GivePlayerMoneyEx(playerid, 1000);
		pData[playerid][pBeras] -= 50;
		new str[500];
		format(str, sizeof(str), "Received_1000x");
		ShowItemBox(playerid, "Uang", str, 1212, 4);
		format(str, sizeof(str), "Removed_50x");
	...
	else
	{
		...
		pData[playerid][pBeras] -= 50;
		new str[500];
		format(str, sizeof(str), "Received_500x");
		ShowItemBox(playerid, "Uang", str, 1212, 4);
		format(str, sizeof(str), "Removed_50x");
		ShowItemBox(playerid, "Beras", str, 19638, 4);
	    Inventory_Update(playerid);
...
CMD:jualsambaldentot(playerid, params[])
{
	if(pData[playerid][pVip] > 0)
	{
	    if(pData[playerid][pProgress] == 1) return ErrorMsg(playerid, "Anda masih memiliki activity progress!");
	    if(pData[playerid][pSambal] < 50) return ErrorMsg(playerid, "Anda Tidak Memiliki 1 Paket sambal Sambal");
	    ShowProgressbar(playerid, "Menjual Sambal..", 10);
		ApplyAnimation(playerid,"INT_HOUSE","wash_up",4.0, 1, 0, 0, 0, 0,1);
		GivePlayerMoneyEx(playerid, 800);
		pData[playerid][pSambal] -= 50;
		new str[500];
		format(str, sizeof(str), "Received_800x");
		ShowItemBox(playerid, "Uang", str, 1212, 4);
		format(str, sizeof(str), "Removed_50x");
	...
	else
	{
		...
		pData[playerid][pSambal] -= 50;
		new str[500];
		format(str, sizeof(str), "Received_400x");
		ShowItemBox(playerid, "Uang", str, 1212, 4);
		format(str, sizeof(str), "Removed_50x");
		ShowItemBox(playerid, "Sambal", str, 19636, 4);
	    Inventory_Update(playerid);
...
CMD:jualtepungdentot(playerid, params[])
{
    new total = pData[playerid][pTepung];
    if(pData[playerid][pJob] != 7) return 1;
    if(pData[playerid][pProgress] == 1) return ErrorMsg(playerid, "Anda masih memiliki activity progress!");
...
CMD:jualguladentot(playerid, params[])
{
